...
LINES=`cat $OUTDIR_LOCAL/part-* | grep lines | awk '{print $2}'`
WORDS=`cat $OUTDIR_LOCAL/part-* | grep words | awk '{print $2}'`
AVG=`echo "$WORDS / $LINES" | bc -l`
echo "Found $WORDS words in $LINES lines for an average of $AVG words/line"
