...
public class SearchTermsMapper extends Mapper<Object, Text, Text, TextLine> {
	...
	public void map(Object ignoredKey, Text value, Context context)
		...
		for (String term : getSearchTerms(context)) {
			if (words.contains(term)) {
				// word \t textline
				TextLine output = new TextLine(words.size(), value.toString());
				context.write(new Text(term), output);
			}
		}
	}
